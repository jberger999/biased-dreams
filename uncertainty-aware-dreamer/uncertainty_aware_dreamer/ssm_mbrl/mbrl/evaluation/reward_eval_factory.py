...
from uncertainty_aware_dreamer.ssm_mbrl.mbrl.evaluation.reward_evaluator import RewardEvaluator
...
class RewardEvalFactory:
    ...
    def get_default_config(finalize_adding: bool = True) -> ConfigDict:
        ...
        config.eval_at_mean = False # for some reason, performance is worse when using mean
