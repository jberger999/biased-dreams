...
def build_hidden_layers(in_features: int,
                        ...
                        activation: str = "ReLU",
                        normalization: str = "") -> tuple[nn.ModuleList, int]:
    ...
    for layer_size in layer_sizes:
        ...
        if normalization != "":
            assert normalization in ["BatchNorm1d", "LayerNorm", "InstanceNorm1d"], f"Normalization {normalization} not supported. Supported: BatchNorm1d, LayerNorm, InstanceNorm1d"
            layers.append(getattr(nn, normalization)(n_out))
